...
class PolyDemo extends JFrame {
    ...
    // and we don't want it reused in arbitrary contexts,
    // so by nesting this class here we can indicate the intent
    // a bit more clearly that this class "goes with" the class above it.
    public class PolyDemoPanel extends JPanel {
         ...
         * we coded this "in general" with respect to the superclass, and not
         * specific to any subclass.
         */
        public void paint(Graphics g) {
            ...
            for (int i = 0; i < myShapes.length; i++) {
                ...
                // Java has RTTI about every object, and it uses this info to choose the correct
                // method to invoke!
                myShapes[i].draw(g);
            }
        }
        ...
        public Shape getRandShape() {
            ...
            switch ((int) (Math.random() * 4)) {
                case 0:
                    ...
                    break;
                case 1:
                    retVal = new Circle( x,y,getRandInt() );// Cube( x, y, getRandInt(), getRandInt(), getRandInt() );
                    break;
                case 2:
