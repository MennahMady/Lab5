...
class Spray extends Shape {
    ...
    public Spray(int x, int y) {
        // We explicitly call a superclass constructor that takes two integers.
        super(x, y);
    }
    ...
    public void draw(Graphics g) {
        ...
        g2d.setPaint(new GradientPaint(x, y, Color.GREEN, x + RADIUS / 4, y +
        ...
        for (int i = 0; i < DENSITY; i++) {
            ...
            g2d.draw(new Ellipse2D.Double(x + xOffset, y + yOffset, x +
                    xOffset + 3, y + yOffset + 3));
        }
    }
}